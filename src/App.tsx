...
const CHANGELOG: Record<string, string[]> = {
  '0.7.1': [
    'Виправлено пересилання повідомлень — тепер працює коректно',
    'Додавання контакту — кнопка + перевірка наявності Telegram',
    'ПІБ співробітників — фіолетовий колір у списку контактів',
  ],
  '0.7.0': [
